...
CALL custom.task.build.graph.from1(merge_label,merge_field,child_labels,jdbc_etl_url,etl_sql,jdbc_task_url,task_hcode,etl_max_min) YIELD procedure_name,cypher_task RETURN procedure_name,cypher_task
```
### 关系CYPHER-TASK自动生成
```
