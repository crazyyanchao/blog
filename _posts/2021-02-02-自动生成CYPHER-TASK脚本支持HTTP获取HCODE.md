---
title: 自动生成CYPHER-TASK脚本支持HTTP获取HCODE
tags: [ONgDB,Cypher,SQL,MySQL]
author: Yc-Ma
show_author_profile: true
key: 2021-02-02-自动生成CYPHER-TASK脚本支持HTTP获取HCODE
pageview: true
---
...
@@ @param {http|https_api} 对唯一性字段启用HTTP规则，并定义HTTP接口地址
@@ @param {http|https_param}
// 过程
