...
- 查看索引统计信息
```
CALL apoc.es.stats('vpc-knowledgegraph-4zarhbj33zcjjkqfo3afso45la.cn-north-1.es.amazonaws.com.cn') YIELD value RETURN value
...
```
```
WITH 'https://vpc-knowledgegraph-4zarhbj33zcjjkqfo3afso45la.cn-north-1.es.amazonaws.com.cn' AS esUrl
...
>使用unwind设置配置
```
UNWIND [{esUrl:'https://vpc-knowledgegraph-4zarhbj33zcjjkqfo3afso45la.cn-north-1.es.amazonaws.com.cn',indexName:'pre_org_cn_node'}] AS configuration
